...
const NotFound = () => {
  return (
    <>
      ...
      <main className='flex flex-col justify-center items-center gap-6 2xl:gap-12 px-4 w-full min-h-screen bg-gray-50 text-center font-inter'>
        <div className='flex flex-col justify-center items-center gap-1 2xl:gap-6 text-green-500'>
